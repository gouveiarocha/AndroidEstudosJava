package com.example.curso_maratonajava.Javacore.X_Serializacao;
...
public class Aluno implements Serializable {
    ...
    private Long id;
    private String nome;
    private transient String password;                  //O comando transient faz com o java ignore esse atributo na Serialização
