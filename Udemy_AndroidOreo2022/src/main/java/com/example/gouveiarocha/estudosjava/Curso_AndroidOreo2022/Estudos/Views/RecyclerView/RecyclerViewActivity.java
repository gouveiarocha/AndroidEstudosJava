package com.example.gouveiarocha.estudosjava.Curso_AndroidOreo2022.Estudos.Views.RecyclerView;
...
import com.example.gouveiarocha.estudosjava.Curso_AndroidOreo2022.Estudos.Views.RecyclerView.adapter.FilmesAdapter;
    ...
    public void eventoClique() {
        recyclerViewFilmes.addOnItemTouchListener(new RecyclerItemClickListener(getApplicationContext(), recyclerViewFilmes, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Toast.makeText(RecyclerViewActivity.this, "Texto Pressionado -" + filme.getTituloFilme(), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onLongItemClick(View view, int position) {
                Filme filme = listaFilmes.get(position);
                Toast.makeText(RecyclerViewActivity.this, "Texto Longo Pressionado -" + filme.getTituloFilme(), Toast.LENGTH_SHORT).show();
            }
        ...
        ItemTouchHelper.Callback itemTouch = new ItemTouchHelper.Callback() {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (direction == ItemTouchHelper.END) {
                    Toast.makeText(RecyclerViewActivity.this, "Arrastou para o fim...", Toast.LENGTH_SHORT).show();
                    recyclerViewFilmes.setAdapter(adapter);
                } else if (direction == ItemTouchHelper.START) {
                    Toast.makeText(RecyclerViewActivity.this, "Arrastou para o inicio...", Toast.LENGTH_SHORT).show();
                    recyclerViewFilmes.setAdapter(adapter);
                }
