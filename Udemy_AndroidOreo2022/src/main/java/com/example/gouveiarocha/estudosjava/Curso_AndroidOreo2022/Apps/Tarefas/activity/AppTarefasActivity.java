...
import com.example.gouveiarocha.estudosjava.Curso_AndroidOreo2022.Apps.Tarefas.adapter.TarefasAdapter;
...
public class AppTarefasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), TarefasAddActivity.class));
            }
        });
    ...
    public void eventoClique() {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getApplicationContext(), recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(getApplicationContext(), TarefasAddActivity.class);
            ...
            public void onLongItemClick(View view, int position) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AppTarefasActivity.this);
                ...
                builder.setPositiveButton("DELETAR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (tarefasDAO.deletar(tarefaSelecionada)) {
                            Toast.makeText(AppTarefasActivity.this, "Tarefa deletada com sucesso!", Toast.LENGTH_SHORT).show();
                            carregarListaTarefas();
                        } else {
                            Toast.makeText(AppTarefasActivity.this, "Erro ao deletar tarefa...", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
