    ...
    private void configuraBotaoSalvar() {
        ...
        botaoSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Aluno alunoCriado = new Aluno(campoNome.getText().toString(), campoTelefone.getText().toString(), campoEmail.getText().toString());
                salva(alunoCriado, dao);
            }
        });
    }

    private void salva(Aluno alunoCriado, AlunoDAO alunoDAO) {
